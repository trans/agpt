...
Connects to `notes/prefix-suffix/prefix-to-suffix-attention.md` (design proposal) and
`notes/prefix-suffix/bayesian-bloom.md` §8 (dual-tree loop) — but **does not require
