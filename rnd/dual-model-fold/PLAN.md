...
measured in `notes/prefix-suffix/prefix-suffix-model-divergence.md`.
...
- `notes/prefix-suffix/prefix-suffix-fold-architecture.md` — original design,
  §3.1 and §3.3 specify the dual-model architecture
- `notes/prefix-suffix/prefix-suffix-model-divergence.md` — the 2.38-nat
